...
String _$gStateMuliplyHash() => r'99b745f9da2e3dadf98286d7632a27ad7dfa0a04';
...
typedef GStateMuliplyRef = AutoDisposeProviderRef<int>;

/// See also [gStateMuliply].
@ProviderFor(gStateMuliply)
const gStateMuliplyProvider = GStateMuliplyFamily();

/// See also [gStateMuliply].
class GStateMuliplyFamily extends Family<int> {
  /// See also [gStateMuliply].
  const GStateMuliplyFamily();

  /// See also [gStateMuliply].
  GStateMuliplyProvider call({
    required int number1,
    required int number2,
  }) {
    return GStateMuliplyProvider(
      number1: number1,
      number2: number2,
    );
  }
  ...
  @override
  GStateMuliplyProvider getProviderOverride(
    covariant GStateMuliplyProvider provider,
  ) {
    return call(
  ...
  @override
  String? get name => r'gStateMuliplyProvider';
}

/// See also [gStateMuliply].
class GStateMuliplyProvider extends AutoDisposeProvider<int> {
  /// See also [gStateMuliply].
  GStateMuliplyProvider({
    ...
    required this.number2,
          ...
          from: gStateMuliplyProvider,
          name: r'gStateMuliplyProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$gStateMuliplyHash,
          dependencies: GStateMuliplyFamily._dependencies,
          allTransitiveDependencies:
              GStateMuliplyFamily._allTransitiveDependencies,
        );
  ...
  bool operator ==(Object other) {
    return other is GStateMuliplyProvider &&
